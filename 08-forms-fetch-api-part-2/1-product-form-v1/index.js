...
export default class ProductForm {
  ...
  async loadData(id) {
    ...
    const productPromise = this.productId ? fetchJson(urlProductData) : [this.defaultFormData];
  ...
  getImagesList() {
    return this.formData.images.map((image) => {
      return this.getImageItemTemplate(image.url, image.source).outerHTML;
    }).join('');
  }
          ...
          <div class="form-group form-group__wide" data-element="sortable-list-container">
            ...
            <div data-element="imageListContainer">
              <ul class="sortable-list">
                ${this.formData.images ? this.getImagesList() : ''}
              </ul>
            </div>
